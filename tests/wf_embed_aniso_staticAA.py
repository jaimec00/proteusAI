...
from utils.model_utils.wf_embedding.anisotropic.aa_scaling.static_aa.cuda.wf_embedding import wf_embedding 
...
def main():
	...
	# setup parameters
	batch, N, d_model, num_classes = 1, 16384, 512, 20
	num_wn = d_model // 2
	...
	torch_out, torch_time, torch_memory = profile_func(wf_embedding, params, start_event, end_event)
