...
title:  		autotune_params.py
description:	autotunes the parameters based on config/autotune.yml file
'''
# ----------------------------------------------------------------------------------------------------------------------
...
if __name__ == "__main__":
	...
	parser.add_argument("--config", type=Path, default="config/autotune.yml", help="Path to the YAML config file")
